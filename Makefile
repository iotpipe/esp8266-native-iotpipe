...
XTENSA_TOOLS_ROOT ?= $(ESP_SDK_ROOT)/xtensa-lx106-elf/bin

# base directory of the ESP8266 SDK package, absolute
SDK_BASE	?= $(ESP_SDK_ROOT)/sdk

# esptool.py path and port
#ESPTOOL		?= $(ESP_SDK_ROOT)/esptool/esptool.py
...
EXTRA_INCDIR1	:= $(addprefix -I,$(EXTRA_INCDIR1))
EXTRA_INCDIR2   := $(addprefix -I,$(EXTRA_INCDIR2))
...
$1/%.o: %.c
	$(vecho) "CC $$<"
	$(Q) $(CC) $(INCDIR) $(MODULE_INCDIR) $(EXTRA_INCDIR1) $(EXTRA_INCDIR2) $(SDK_INCDIR) $(CFLAGS) -c $$< -o $$@
endef
